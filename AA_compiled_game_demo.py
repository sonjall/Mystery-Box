...
class Start:
    ...
    def check_funds(self):
        ...
        # get error background colours (and assume that there are no
        # errors at the start...
        error_back = "#ffafaf"
        has_errors = "no"
...
class Game:
    def __init__(self, partner, stakes, starting_balance):
        ...
        # If users press cross at top, game quit
    ...
    def reveal_boxes(self):
        ...
        for item in range(0, 3):
            ...
            if 0 < prize_num <= 5:
                ...
                back_color = "#B7B7B5"  # Silver Colours
    ...
    def help(self):
        get_help = Help(self)
        get_help.help_text.config(text="Choose an amount to play with and then "
                                       "choose the stakes. Higher stakes cost "
                                       "more per round but you can win more "
                                       "as well. \n\n"
                                       "When you enter the play area, you will "
                                       "see three mystery boxes. To reveal "
                                       "the contents of the boxes, click the "
                                       "'Open Boxes' button. If you don't have "
                                       "enough money to play, the button will "
                                       "turn red and you will need to quit "
                                       "the game. \n\n"
                                       "The contents of the boxes will be added "
                                       "to your balance. The boxes could contain...\n\n"
                                       "Low: Lead ($0) | Copper ($1) | Silver ($2)"
                                       " | Gold ($10)\n"
                                       "Medium: Lead ($0) | Copper ($2) | Silver ($4)"
                                       " | Gold ($25)\n"
                                       "High: Lead ($0) | Copper ($5) | Silver ($10)"
                                       " | Gold ($50)\n\n"
                                       "If each box contains gold, you earn $30 (low "
...
class Help:
    def __init__(self, partner):
        ...
        # set up GUI frame
        self.help_frame = Frame(self.help_box, width=500, bg=background)
